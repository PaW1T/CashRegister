    ...
    class Util
    {
        ...
        public static List<Article> getArticles()
        {
            ...
            using (StreamReader reader = File.OpenText(ARTICLES_FILE_NAME + ".json"))
            {
                ...
                articles = JsonConvert.DeserializeObject<List<Article>>(json, new ArticleCreationConverter());
            }
            if (articles == null)
            {
        ...
        public static void printDailyArticlesReport()
        {
            ...
            {
                Dictionary<int, double> dailyArticles = new Dictionary<int, double>();
                ...
                foreach (Bill b in bills)
                {
                    foreach (Article a in b.articles)
                    {
                        ...
                        if (hasValue)
                        {
                            dailyArticles[a.id] = value + a.ammount;
                        }
                        else
                        {
                            dailyArticles.Add(a.id, a.ammount);
                        }
                ...
                else
                {
                    ...
                    foreach (KeyValuePair<int, double> item in dailyArticles)
                    {
